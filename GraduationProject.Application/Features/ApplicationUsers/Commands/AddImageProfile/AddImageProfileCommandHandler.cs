...
namespace GraduationProject.Application.Features.ApplicationUsers.Commands.AddImageProfile
{
    public class AddImageProfileCommandHandler : IRequestHandler<AddImageProfileCommand, Result<string>>
    {
        ...
        public AddImageProfileCommandHandler(UserManager<User> userManager, IFileServices fileService, ICurrentUserService currentUserService)
        {
