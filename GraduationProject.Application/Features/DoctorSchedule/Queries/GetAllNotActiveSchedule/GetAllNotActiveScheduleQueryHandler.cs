...
{
    public class GetAllNotActiveScheduleQueryHandler : IRequestHandler<GetAllNotActiveScheduleQuery, Result<List<DoctorScheduleDto>>>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly ICurrentUserService currentUserService;

        public GetAllNotActiveScheduleQueryHandler(IUnitOfWork unitOfWork, ICurrentUserService currentUserService)
        {
            this.unitOfWork = unitOfWork;
            this.currentUserService = currentUserService;
        }
        public async Task<Result<List<DoctorScheduleDto>>> Handle(GetAllNotActiveScheduleQuery request, CancellationToken cancellationToken)
        {
