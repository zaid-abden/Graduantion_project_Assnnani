    ...
    public partial class asak : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    StudentDoctorId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentDoctors", x => x.StudentDoctorId);
                    table.ForeignKey(
                        name: "FK_StudentDoctors_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DoctorCertificate = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    AdminId = table.Column<int>(type: "int", nullable: false),
                    StudentDoctorId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    AIStatus = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Scans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Scans_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AI_Reports", x => x.ReportId);
                    table.ForeignKey(
                        name: "FK_AI_Reports_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        principalColumn: "PatientId");
                    table.ForeignKey(
                        name: "FK_AI_Reports_Scans_ScanId",
                        column: x => x.ScanId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AI_Reports_DoctorId",
                table: "AI_Reports",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_AI_Reports_PatientId",
                table: "AI_Reports",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_AI_Reports_ScanId",
                table: "AI_Reports",
                column: "ScanId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AI_Reports_StudentDoctorId",
                table: "AI_Reports",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalRecords_StudentDoctorId",
                table: "MedicalRecords",
                column: "StudentDoctorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Verifications_DoctorId",
                table: "Verifications",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_Verifications_StudentDoctorId",
                table: "Verifications",
                column: "StudentDoctorId");
        }
